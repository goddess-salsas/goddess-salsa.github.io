...
(function() {
    ...
    $window.on('load', function() {
        ...
        if (plugins.materialParallax.length) {
            if (!isNoviBuilder && !isIE && !isMobile) {
                ...
                for (var k = 0; k < plugins.materialParallax.length; k++) {
                    var $parallax = $(plugins.materialParallax[k]);
    ...
    $(function() {
        ...
        function toggleSwiperCaptionAnimation(swiper) {
            ...
            for (var m = 0; m < nextSlide.length; m++) {
                nextSlideItem = $(nextSlide[m]);
        ...
        function initMaps() {
            ...
            $.getScript('//maps.google.com/maps/api/js?' + (key ? 'key=' + key + '&' : '') + 'sensor=false&libraries=geometry,places&v=quarterly', function() {
                ...
                for (var i = 0; i < plugins.maps.length; i++) {
                    var zoom = parseInt(plugins.maps[i].getAttribute("data-zoom"), 10) || 12;
                    var styles = plugins.maps[i].hasAttribute('data-styles') ? JSON.parse(plugins.maps[i].getAttribute("data-styles")) : [];
                    var center = plugins.maps[i].getAttribute("data-center") || "Chicago";
